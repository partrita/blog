...
BLOG_AUTHOR = "KT"  # (translatable)
BLOG_TITLE = "Netsphere"  # (translatable)
...
BLOG_EMAIL = "deepthought@postech.ac.kr"
BLOG_DESCRIPTION = "This is a demo site for me"  # (translatable)
